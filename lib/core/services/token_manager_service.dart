...
class TokenManager {
  ...
  Future<void> saveToken(String token, {Duration validity = const Duration(minutes: 10)}) async {
    ...
    print("token_expiration+=+: ${_tokenExpirationTime!.millisecondsSinceEpoch}");
    await SharedPrefHelper.setData('token_expiration', _tokenExpirationTime!.millisecondsSinceEpoch);
  ...
  Future<bool> checkAndRestoreToken() async {
    ...
    final expirationTime = DateTime.fromMillisecondsSinceEpoch(expirationMillis as int);
